        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/customer/login" className="text-background/70 transition-colors hover:text-background">
                  Kundenportal
                </Link>
              </li>
              <li>
                <Link to="/jockey/login" className="text-background/70 transition-colors hover:text-background">
                  Fahrer-Portal
                </Link>
              </li>
              <li>
                <Link to="/workshop/login" className="text-background/70 transition-colors hover:text-background">
                  Werkstatt-Portal
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/impressum" className="text-background/70 transition-colors hover:text-background">
                  Impressum
                </Link>
              </li>
              <li>
                <Link to="/datenschutz" className="text-background/70 transition-colors hover:text-background">
                  Datenschutz
                </Link>
              </li>
              <li>
                <Link to="/agb" className="text-background/70 transition-colors hover:text-background">
                  AGB
                </Link>
              </li>
            </ul>
