...
export default function JockeyLoginPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                data-testid="jockey-username-input"
                required
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  data-testid="jockey-password-input"
                  required
                />
                <button
                  type="button"
      ...
      <div className="hidden lg:flex lg:w-1/2 lg:items-center lg:justify-center lg:bg-gradient-to-br lg:from-jockey lg:via-jockey lg:to-jockey/90 lg:p-12">
