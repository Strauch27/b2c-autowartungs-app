      ...
      <div className="flex w-full flex-col justify-center px-4 py-12 lg:w-1/2 lg:px-20 lg:pr-12">
        ...
        <div className="w-full max-w-md space-y-8">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">Bearbeiten Sie Aufträge, erstellen Sie Kostenvoranschläge und kommunizieren Sie mit Kunden.</p>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 lg:items-center lg:justify-center lg:bg-gradient-to-br lg:from-workshop lg:via-workshop lg:to-workshop/90 lg:p-12">
        <div className="max-w-md space-y-6">
          ...
          <div className="text-center space-y-2 text-white">
            <h2 className="text-2xl font-bold">Werkstatt-Portal</h2>
            <p className="text-white/80">
              Bearbeiten Sie Aufträge, erstellen Sie Kostenvoranschläge und kommunizieren Sie mit Kunden.
            </p>
          </div>
        </div>
      </div>
